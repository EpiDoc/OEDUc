...
<a role="button" class="btn btn-info" href="http://betamasaheft.aai.uni-hamburg.de:8080/exist/apps/OEDUc/newentry.html">
                   New Entry
                </a>
};  
...
return
<div class="row">
<div class="col-md-3"><a href="http://betamasaheft.aai.uni-hamburg.de:8080/exist/apps/OEDUc/inscription/{$id}">{$x//t:title/text()}</a>  </div>
<div class="col-md-3"><a role="button" class="btn btn-success btn-xs" href="http://betamasaheft.aai.uni-hamburg.de:8080/exist/apps/OEDUc/update.html?id={$id}&amp;new=false">update</a></div>
<div class="col-md-3"><a role="button" class="btn btn-warning btn-xs" href="http://betamasaheft.aai.uni-hamburg.de:8080/exist/apps/OEDUc/edit/delete-confirm.xq?id={$id}">delete</a></div>
<div class="col-md-3"><a href="http://betamasaheft.aai.uni-hamburg.de:8080/exist{concat(substring-after(base-uri($x), '/db'),'/', $id,'.xml')}" role="button" class="btn btn-info btn-xs" >XML</a></div>
</div>
        ...
        let $id := root($term)//t:text/@xml:id
          ...
          return
            <div class="row reference ">
               <div class="col-md-4"><a href="http://betamasaheft.aai.uni-hamburg.de:8080/exist/apps/OEDUc/inscription/{data($id)}">{$term-name}</a></div>
...
let $d := doc($targetfileuri ||'/' || $id || '.xml')
...
<div class="col-md-12 btn-group">
        <a role="button" class="btn btn-info" href="http://betamasaheft.aai.uni-hamburg.de:8080/exist/apps/OEDUc/update.html?id={$app:id}&amp;new=false">Update</a>
        <a role="button" class="btn btn-danger" href="http://betamasaheft.aai.uni-hamburg.de:8080/exist/apps/OEDUc/edit/delete-confirm.xq?id={$app:id}">Delete</a>
        <a href="http://betamasaheft.aai.uni-hamburg.de:8080/exist{concat(substring-after(base-uri($file), '/db'),'/', $app:id,'.xml')}" role="button" class="btn btn-success" >XML</a>
        </div>)

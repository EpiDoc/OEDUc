        ...
        <html>
            ...
            <body>
                <div
                    ...
                    <a
                        href="/exist/apps/pondera/newentry.html"
        ...
        <html>
            ...
            <body>
                <div
                    ...
                    <p> Your entry for 
                        <a href="/exist/apps/OEDUc/inscription/{$Newid}" target="_blank"><span
                            class="lead">{$title}</span></a> has been saved!</p>
                   
                    <a
                        href="/exist/apps/OEDUc/newentry.html">Create another entry</a>
                </div>
